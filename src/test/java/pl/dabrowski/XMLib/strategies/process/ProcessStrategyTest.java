...
import pl.dabrowski.XMLib.strategies.process.impl.SchemaElementStrategy;
...
public class ProcessStrategyTest {
	...
	public void test3() throws Exception {
		...
		ElementKind[] kindEquals= {ElementKind.FIELD,ElementKind.FIELD,ElementKind.FIELD,ElementKind.CONSTRUCTOR, ElementKind.METHOD};
		ElementKind[] kindTypeEquals= {ElementKind.CLASS,null,ElementKind.ENUM,null,null};
